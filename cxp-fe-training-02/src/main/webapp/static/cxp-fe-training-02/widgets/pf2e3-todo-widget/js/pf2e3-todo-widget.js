define(['jquery', 'launchpad/modules/ui/scripts/components/responsive/scripts/libs/responsive'], function($, Responsive) {
    ...
    var self = null,
        SELECTORS = {
            'FORM': '[data-js="bt-pf2e3-todo-form"]',
            'LIST': '[data-js="bt-pf2e3-todo-list"]',
            'TEMPLATE': '[data-template="bt-pf2e3-task"]',
            'UPDATE': '[data-js="bt-pf2e3-update-task"]',
            'REMOVE': '[data-js="bt-pf2e3-remove-task"]',
            'INPUT': ':input[name="task"]',
            'ROW': '[data-js="bt-pf2e3-todo-row"]'
        };
